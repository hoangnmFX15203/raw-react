...
class Contact extends Component {
    ...
    validate(firstname, lastname, email, telnumber) {
        ...
        const reg = /^\d+$/;
        if (this.state.touched.telnum && !reg.test(telnumber))
    ...
    render() {
        const errors = this.validate(this.state.firstname, this.state.lastname, this.state.email, this.state.telnumber);
        return (
